...
using Recycle.Areas.Shop.ViewModels.Order;
...
namespace Recycle.Areas.Shop.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public OrderController(RecycleContext dbContext, UserIdentityService userIdentity, UsersService users, AuthenticateService authenticateService, ClientShoppingCartService clientCart)
        {
