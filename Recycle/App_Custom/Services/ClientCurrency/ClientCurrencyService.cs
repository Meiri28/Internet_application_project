...
using Recycle.WebServices.CurrencyFreaksApi;
using Recycle.WebServices.IpApi;
...
namespace Recycle.App_Custom.Services.ClientCurrency
{
    /// <summary>
    ...
    public class ClientCurrencyService
    {
        ...
        public ClientCurrencyService(IOptions<ClientCurrencyOptions> options, IHttpContextAccessor httpContextAccessor, IConfiguration configuration, IMemoryCache cache, RecycleContext dbContext, UserIdentityService userIdentity, UsersService users)
        {
