...
namespace Recycle.App_Custom.Services.ClientTheme
{
    /// <summary>
    ...
    public class ClientThemeService
    {
        ...
        public ClientThemeService(IOptions<ClientThemeOptions> options, IHttpContextAccessor httpContextAccessor, RecycleContext dbContext, UserIdentityService userIdentity, UsersService users)
        {
